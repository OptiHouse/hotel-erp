...
class ChoreControllerTest {
    ...
    void shouldCreateChore() {
        ...
        // when
        var response = choreController.createChore(choreRequest);
    ...
    void shouldAssignEmployee() throws ApplicationException {
        ...
        var response = choreController.assignToChore(choreId, employeeId);
    ...
    void shouldChangeChoreStatus(final String action, final ChoreStatus expected) throws Exception {
        ...
        var response = choreController.changeChoreStatus(choreId, action);
